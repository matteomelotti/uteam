const it = {
  ...
  authService: {
    signup: {
      subject: '[UTeam] Nuovo iscritto',
      messageAdmin: '%{email} - %{subdomain} si è iscritto.'
    }
  },
  subscriptionService: {
    runNotifyExpiringTrials: {
      subject: '[UTeam] Il periodo di prova scadrà in %{daysToExpire} giorno/i',
    ...
    runNotifyPaymentFailed: {
      subject: '[UTeam] L\'abbonamento sarà disattivato in %{daysToExpire} giorno/i',
